  ...
  return (
    ...
    <div className="min-h-screen bg-center bg-white "
     >
      ...
      <div
  className="w-full translate-y-15 h-[30vh] bg-position-[50%_43%] bg-cover "
  style={{
...
/>
      ...
      <div className="max-w-7xl mx-auto mt-45">
        ...
        <form className="space-y-12">
          ...
          <div className="grid md:grid-cols-[0.8fr_1.5fr] gap-16 items-center justify-start">
            <div className="text-gray-700">
              5. Are you above 18 years of age?
            </div>
          ...
          <div className="grid md:grid-cols-[0.8fr_1.5fr] gap-16 items-start justify-start">
            <div className="text-gray-700">
              6. How would you like to participate in this community?
            </div>
          ...
          <div className="grid md:grid-cols-[0.8fr_1.5fr] gap-16 items-start justify-start">
            <div className="text-gray-700">
              7. What kinds of books or texts do you mostly engage with?
            </div>
            <div className="flex flex-wrap gap-3 max-w-md">
          ...
          <div className="grid md:grid-cols-[0.8fr_1.5fr] gap-16 items-start justify-start">
            <div className="text-gray-700">
              8. Name 1–3 authors, thinkers, or books that have shaped your thinking
            </div>
            <div className="max-w-md">
              <textarea
          ...
          <div className="grid md:grid-cols-[0.8fr_1.5fr] gap-16 items-start justify-start">
            <div className="text-gray-700">
              9. Why do you wish to be part of this reading and conversation community?
            </div>
            <div className="max-w-md">
              <textarea
          ...
          <div className="grid md:grid-cols-[0.8fr_1.5fr] gap-16 items-start justify-start">
            <div className="text-gray-700">
              10. In your view, what is often missing in contemporary public conversations? <span className="text-gray-400">(Optional)</span>
            </div>
            <div className="max-w-md">
              <textarea
          ...
          <div className="grid md:grid-cols-[0.8fr_1.5fr] gap-16 items-start justify-start">
            <div className="text-gray-700">
              11. Have you spoken publicly before, in any setting?
            </div>
            <div className="flex flex-wrap gap-3 max-w-md">
              <PillOption 
          ...
          <div className="grid md:grid-cols-[0.8fr_1.5fr] gap-16 items-start justify-start">
            <div className="text-gray-700">
              12. If you speak or wish to speak, what kinds of ideas, texts, or questions do you hope to engage with? <span className="text-gray-400">(Optional)</span>
            </div>
            <div className="max-w-md">
              <textarea
          ...
          <div className="grid md:grid-cols-[0.8fr_1.5fr] gap-16 items-center justify-start">
            <div className="text-gray-700">
              13. If available, you may share a link to any talk, writing, or work <span className="text-gray-400">(Optional)</span>
            </div>
            <div className="max-w-md">
              <input
                type="url"
          ...
          <div className="grid md:grid-cols-[0.8fr_1.5fr] gap-16 items-start justify-start">
            <div className="text-gray-700">
              14. This is a slow-growing, and depth-oriented community. Are you comfortable with that pace and scale?
            </div>
            <div className="flex gap-3 max-w-md">
          ...
          <div className="grid md:grid-cols-[0.8fr_1.5fr] gap-16 items-start justify-start">
            <div className="text-gray-700">
              15. Are you open to reading attentively, listening carefully, and engaging respectfully—even in disagreement?
            </div>
            <div className="flex gap-3 max-w-md">
          ...
          <div className="grid md:grid-cols-[0.8fr_1.5fr] gap-16 items-start justify-start">
            <div className="text-gray-700">
              16. This community is curated. In order to preserve its quality and seriousness, the curator may intervene or set boundaries in cases of disruptive or inappropriate conduct. Are you comfortable with this understanding?
            </div>
            <div className="flex gap-3 max-w-md">
          ...
          <div className="grid md:grid-cols-[0.8fr_1.5fr] gap-16 items-start justify-start">
            <div className="text-gray-700">
              17. Any final reflection you would like to share? <span className="text-gray-400">(Optional)</span>
            </div>
            <div className="max-w-md">
              <textarea
